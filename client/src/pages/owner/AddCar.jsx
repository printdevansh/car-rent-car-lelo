...
const AddCar = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title='AddNew Car' subtitle='Fill in details to list a new car for booking, including pricing, availability, and car specifications.'/>
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='flex flex-col w-full'>
          ...
          <select onChange={e=>setCar({...car, location:e.target.value})} value={car.location} className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
            ...
            <option value="Gas">New York</option>
            <option value="Diesel">Los Angeles</option>
            <option value="Petrol">Houston</option>
            <option value="Electric">Chicago</option>
            </select>
        </div>
        ...
        <div className='flex flex-col w-full'>
          ...
          <textarea rows={5} placeholder="A luxurious SUV with a spacious interior and a powerful engine." required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.description} onChange={e=>setCar({...car, description:e.target.value})}></textarea>
        </div>
